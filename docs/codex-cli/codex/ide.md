...
- [Prompt with editor context](../prompting.md#use-editor-context)
- [Explore IDE commands](../developer-commands.md)
- [Configure the extension](../developer-settings.md)

## See what Codex can do in your IDE

Stay close to the code while Codex explains, edits, reviews, and delegates.

- [Use the context already open](../prompting.md#use-editor-context): Add an open file, a selection, or a recent chat to the composer, then ask Codex to explain or edit the code with that context already attached.
- [Review changes beside your code](../prompting.md): Review a concise summary and the changed lines without an extra navigation pane. Inspect the two affected files, keep the edits you want, and ask for a follow-up from the same view.
...
- [You are making focused edits](../prompting.md#use-editor-context): Keep the relevant files and Codex in the same view.
- [You are learning unfamiliar code](../prompting.md#use-editor-context): Ask about the files and symbols already open in the editor.
- [You want to review changes in place](../prompting.md): Inspect and apply edits alongside the source.
