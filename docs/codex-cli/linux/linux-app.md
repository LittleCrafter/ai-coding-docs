...
[desktop app quickstart](../quickstart.md).
...
and follow the [desktop app quickstart](../quickstart.md).
...
[Computer Use](../computer-use.md) is available on macOS and Windows but not
...
- Follow the [desktop app quickstart](../quickstart.md).
- Set up the [Chrome extension](../chrome-extension.md) for browser integration.
- Review [permissions](../permissions.md) for local projects and commands.