...
For Codex cloud network settings, see [Internet Access](./cloud/internet-access.md).
...
[Control available permission profiles](./enterprise/managed-configuration.md#control-available-permission-profiles)
...
[Managed configuration](./enterprise/managed-configuration.md#configure-network-access-requirements).
...
broaden. See [Managed configuration](./enterprise/managed-configuration.md)
...
- **Codex cloud:** These tasks use their environment's own
  [internet access settings](./cloud/internet-access.md).
...
- On Linux and WSL, Codex uses [bubblewrap](https://github.com/containers/bubblewrap)
  ...
  are refused.
- On native Windows, [`elevated` sandboxing](./windows/windows-sandbox.md#windows-sandbox)
