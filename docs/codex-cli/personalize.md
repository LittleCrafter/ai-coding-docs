...
[Memories](./customization/memories.md) let ChatGPT carry useful context from earlier chats
...
[Computer History](./customization/computer-history.md) is an opt-in macOS
