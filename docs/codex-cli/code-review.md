...
When a [local project includes multiple folders](./projects.md#use-local-projects-for-folders-and-codebases)
...
- Clicking a file name typically opens that file in your chosen editor. You
  can choose the default editor in [developer settings](./developer-settings.md#app-project-and-terminal-behavior).
