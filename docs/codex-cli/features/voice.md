...
or use [voice dictation](../prompting.md#use-voice-dictation) to enter prompt
...
ChatGPT Voice follows the same [permissions](../permission-modes.md) as
...
[appshot](../appshots.md#permissions-and-safety) of your frontmost window and
...
dictation](../prompting.md#use-voice-dictation) when you only want to turn
...
limits](../pricing.md#chatgpt-voice-in-desktop).
