...
If you discover a security vulnerability, follow the [security policy](https://github.com/openai/codex/blob/main/SECURITY.md) instead of reporting it in a public issue.
