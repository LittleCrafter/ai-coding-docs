...
[GPT-6 Astra](./models.md#gpt-6-astra) when it is available in your model
...
[built-in browser](./browser.md) first.
...
[remote control](./remote-connections.md) from your phone to check progress
...
[managed browser and Computer Use controls](./enterprise/managed-configuration.md#control-browser-and-computer-use).
