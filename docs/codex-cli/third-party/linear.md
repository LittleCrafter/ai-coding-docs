...
Codex in Linear is available on paid plans (see [Pricing](../pricing.md)).
...
1. Set up [Codex cloud chats](../cloud.md) by connecting GitHub in [Codex](https://chatgpt.com/codex) and creating an [environment](../environments/cloud-environment.md) for the repository you want Codex to work in.
...
For more on security, see the [Codex security documentation](../agent-approvals-security.md).
