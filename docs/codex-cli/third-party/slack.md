...
1. Set up [Codex cloud chats](../cloud.md). You need a Plus, Pro, Business, Enterprise, or Edu plan (see [ChatGPT pricing](https://chatgpt.com/pricing)), a connected GitHub account, and at least one [environment](../environments/cloud-environment.md).
