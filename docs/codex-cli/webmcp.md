...
In the [built-in browser](./browser.md) in the ChatGPT desktop app, ChatGPT
...
[plugin with an MCP server](./build-plugins.md) can provide an integration
...
[Site](./sites.md) you're working on. Describe what an agent should be able
