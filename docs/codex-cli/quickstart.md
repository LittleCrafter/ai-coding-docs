...
2.  <h3 id="setup-app-sign-in">Open the ChatGPT desktop app and sign in</h3>
    ...
    You may also use Codex with an API key. [Some features might not be available](./pricing.md#feature-availability).
...
3.  <h3 id="setup-app-select-workspace">Select where ChatGPT should work</h3>
    ...
    files in the folder you choose. [Learn more about chats and projects](./projects.md).
