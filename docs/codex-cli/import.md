...
| `settings.json`                   | [`config.toml`](./config-file/config-basic.md)        |
| Skills                            | [Skills](./build-skills.md)                           |
| Plugins                           | Plugins                                                 |
| Existing project folders          | Projects using the same folders                         |
| Project memories from Claude Code | [Memories](./customization/memories.md)               |
| Chats from the last 30 days       | ChatGPT chats                                           |
| MCP server configuration          | [Codex MCP configuration](./extend/mcp.md)            |
| Hooks                             | [Codex hooks](./hooks.md)                             |
| Slash commands                    | [Skills](./build-skills.md)                           |
| Subagents                         | [Codex subagents](./agent-configuration/subagents.md) |
...
there. See [Use ChatGPT](./use-chatgpt.md) for guidance on starting your
next task.