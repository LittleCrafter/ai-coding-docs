...
[Computer Use](./computer-use.md). Computer Use on Windows runs in the
...
- [ChatGPT desktop app](./app.md)
- [Features](./features.md)
- [ChatGPT desktop app settings](./reference/settings.md)
- [Computer Use](./computer-use.md)
- [Chrome extension](./chrome-extension.md)
- [Command line options](./developer-commands.md)
