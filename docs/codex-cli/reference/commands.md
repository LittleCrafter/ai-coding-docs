...
[Linux desktop app guide](../linux/linux-app.md#wayland-support).
...
and permission details, see [Plugins](../plugins.md).
...
Plugin links use different forms depending on whether you are installing from a marketplace, opening a plugin, or working from a local `marketplace.json`. For plugin basics, see [Plugins](../plugins.md). For local or repo marketplace setup, see [Build plugins](https://developers.openai.com/plugins/build/plugins#build-your-own-curated-plugin-list).
