...
[Learn more about how to use the review pane](../code-review.md).
...
[local environment](../environments/local-environment.md) or copy ignored setup files
with [`.worktreeinclude`](../environments/git-worktrees.md#copy-ignored-local-files-into-managed-worktrees).
Alternatively, you can check out the changes in your regular local project. See
the [worktrees documentation](../environments/git-worktrees.md) to learn more.
