...
For a CI example, see [Non-interactive mode](./non-interactive-mode.md) and explore the source in the [openai/codex-action repository](https://github.com/openai/codex-action).
