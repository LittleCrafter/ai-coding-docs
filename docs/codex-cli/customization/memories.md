...
`~/.codex`. See [Config and state locations](../config-file/config-advanced.md#config-and-state-locations)
...
[Config basics](../config-file/config-basic.md) and the [configuration
reference](../config-file/config-reference.md).
