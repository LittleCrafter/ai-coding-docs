...
Computer History is **off by default** for ChatGPT Pro, Business, and
  ...
  History also requires [Memories](./memories.md) and is not
...
- **Memories:** Computer History also requires [Memories](./memories.md).
...
[chat-level controls as other Codex memories](./memories.md#control-memories-per-chat).
