...
The `@openai/codex-security` package is public. Running scans requires Codex
  Security access. Follow the [CLI quickstart](../cli.md) to install
  the CLI and sign in.
...
setup](./reference.md#use-openrouter-or-fireworks) or [Amazon
Bedrock setup](./reference.md#use-amazon-bedrock).
...
reference](./reference.md#codex-security-bulk-scan). For common
