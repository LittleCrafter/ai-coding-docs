...
with the [CLI quickstart](../cli.md).
...
see the [CLI reference](./reference.md#select-scan-authentication).
...
See [Run bulk security scans](./bulk-scans.md) for GitHub
...
context](./reference.md#add-security-context).
...
artifacts](./reference.md#scan-artifacts) for the full layout.
...
reference](./reference.md#codex-security-findings).
...
configuration](./reference.md#configure-deep-scans).
