...
The Codex Security SDK is [publicly available on
  ...
  guide](../codex-sdk.md). For terminal and CI workflows, see the [Codex
  Security CLI quickstart](./cli.md).
...
Bedrock](./cli/reference.md#use-amazon-bedrock), set
...
Continue with the [CLI quickstart](./cli.md), [CI
guide](./cli/ci.md), or [CLI
