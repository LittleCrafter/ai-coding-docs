...
use. Learn more about [using Chat and ChatGPT Work together](./use-chatgpt.md).
...
On the [desktop app](./app.md), ChatGPT Work can also use local files, apps, and the
...
Learn more about [scheduled tasks](./automations.md).
...
Learn more about [working efficiently](./prompting.md#prompting-for-work).

If a task pauses for a safety review, follow the notice and review any available
findings before continuing. See [safety monitoring and paused tasks](./agent-approvals-security.md#safety-monitoring-and-paused-tasks).
