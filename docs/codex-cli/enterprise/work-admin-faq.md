...
[ChatGPT Work Overview](./chatgpt-work-overview.md).
...
- **Plugins and apps:** Plugin policy governs plugin availability and
  ...
  available. See [Plugin controls](./apps-and-connectors.md),
  [Plugins](../plugins.md), and the
...
[Admin rollout guide](./admin-setup.md) and
[Governance](./governance.md) alongside the workspace controls.
...
[Compliance API](./compliance-api.md) documentation for exact data
...
[Workspace analytics](./workspace-analytics.md) and the
...
opt-in. See
[Monitoring and telemetry](../agent-approvals-security.md#monitoring-and-telemetry).
...
[managed configuration](./managed-configuration.md) and
[permission profiles](../permissions.md). Those local-client controls don't
...
[ChatGPT Work and Codex share pricing, credits, and usage limits](../pricing.md).
...
see [ChatGPT Work: usage and cost](./chatgpt-work-usage-and-cost.md).
...
| ------------------------ | ----------------------------------------------------------------------------- | ---------------------------------------------------------------- |
| Work overview            | How cloud execution, browser access, network policy, and data boundaries work | [ChatGPT Work Overview](./chatgpt-work-overview.md) |
| Workspace setup and RBAC | Who can use and administer Codex                                              | [Admin rollout guide](./admin-setup.md)             |
| Authentication           | How ChatGPT sign-in, API key sign-in, and workspace policy differ             | [Authentication](../auth.md)                                    |
| Approvals and sandboxing | How Codex controls file, command, network, and side-effecting tool actions    | [Agent approvals and security](../agent-approvals-security.md)  |
| Managed policy           | How admins enforce Codex settings users can't override                        | [Managed configuration](./managed-configuration.md) |
| Runtime environments     | How Codex cloud setup, secrets, caches, and task phases work                  | [Cloud environments](../environments/cloud-environment.md)      |
| Internet access          | How Codex cloud domain allowlists and HTTP methods work                       | [Agent internet access](../cloud/internet-access.md)            |
| Permissions              | How filesystem, network, and deny-read controls work                          | [Permissions](../permissions.md)                                |
| Observability            | How analytics, reporting, and compliance exports work                         | [Governance](./governance.md)                       |
| Automation credentials   | How access tokens are created, limited, revoked, and audited                  | [Access tokens](./access-tokens.md)                 |
