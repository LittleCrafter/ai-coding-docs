...
[skills](../skills-and-plugins.md), and
...
| Included skills         | Which reusable instructions the installed plugin contributes             | The plugin package and [Skill controls](./skills.md)                                                               |
...
[Codex MCP configuration](../extend/mcp.md).
