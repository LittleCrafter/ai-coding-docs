...
[ChatGPT Work cloud security](./chatgpt-work-cloud-security.md).

For device access, local browser sessions, managed policies, and local data
handling, see
[ChatGPT Work local security](./chatgpt-work-local-security.md).
...
See [Code and shell sandboxing](../sandboxing.md),
...
[Code and shell sandboxing](../sandboxing.md) and
...
[Plugin controls](./apps-and-connectors.md),
...
and the [ChatGPT Work Admin FAQ](./work-admin-faq.md).
