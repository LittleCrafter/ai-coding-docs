...
- An effective Codex authentication policy that permits ChatGPT authentication
  ...
  method or workspace](../auth.md#enforce-a-login-method-or-workspace).
...
[Windows sandbox](../windows/windows-sandbox.md). Other Windows sandbox modes
...
[`permissions.filesystem.deny_read`](./managed-configuration.md#enforce-deny-read-requirements)
...
guidance](./compliance-api.md) to export the events your workspace
