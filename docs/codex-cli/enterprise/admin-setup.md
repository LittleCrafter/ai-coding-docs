...
[Agent approvals and security](../agent-approvals-security.md) and the
...
- [User lifecycle management](./user-lifecycle.md)
...
examples, see
[Managed configuration](./managed-configuration.md) and the
...
| ------------- | ------------------------------------------------ | ---------------------------------------------------------- |
| Configuration | [Config basics](../config-file/config-basic.md) | Set repository defaults for supported local clients        |
| Rules         | [Rules](../agent-configuration/rules.md)        | Control commands that require approval outside the sandbox |
| Skills        | [Build skills](../build-skills.md)              | Make repository workflows available to supported clients   |
...
[Cloud environments](../environments/cloud-environment.md),
[GitHub integration](../third-party/github.md), and
[Agent approvals and security](../agent-approvals-security.md) for Codex cloud
...
See [Plugin controls](./apps-and-connectors.md) and
[Skill controls](./skills.md) for the complete model.
...
- Use [Workspace analytics](./workspace-analytics.md) for
  interactive ChatGPT workspace analytics and Codex analytics.
- Use the [Analytics API](./analytics-api.md) for programmatic,
  aggregated reporting through the Codex Analytics API.
- Use the [Compliance API](./compliance-api.md) for audit and
  investigation records.
- Use [ChatGPT usage limits and spend controls](./usage-limits.md)
