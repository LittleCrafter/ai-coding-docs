...
| Codex in the ChatGPT desktop app, Codex CLI, and IDE extension with ChatGPT sign-in        | Models supported by the specific client and the access available to the signed-in ChatGPT identity    | [Codex models](../models.md) and current workspace guidance                                                                  |
| Codex cloud                                                                                | Models supported by hosted Codex workflows and the access available to the signed-in ChatGPT identity | [Codex models](../models.md) and [Codex cloud](../cloud.md)                                                                 |
| Codex in the ChatGPT desktop app, Codex CLI, and IDE extension with API-key authentication | The OpenAI API organization and project associated with the key                                       | [Authentication](../auth.md) and the [OpenAI API Platform](https://platform.openai.com/docs/overview)                        |
...
[`requirements.toml`](../config-file/config-reference.md#requirementstoml).
...
See [pricing](../pricing.md) for allowance and billing
guidance and [safety monitoring](../agent-approvals-security.md#safety-monitoring-and-paused-tasks)
...
[Codex models](../models.md#gpt-55-retirement) and
...
See [Codex models](../models.md#deprecated-codex-models) and
[managed configuration](./managed-configuration.md)
...
- [Codex models](../models.md)
- [Codex feature availability by plan](../pricing.md#feature-availability)
