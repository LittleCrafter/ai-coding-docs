...
[App server](../app-server.md); don't reuse the Codex access token as the
transport token. See
[Authentication and network environment variables](../config-file/environment-variables.md#authentication-and-network).
