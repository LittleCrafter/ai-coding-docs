...
[`env_key`](./config-advanced.md#custom-model-providers).
...
[Config and state locations](./config-advanced.md#config-and-state-locations).
...
[`env_key`](./config-advanced.md#custom-model-providers) in the model provider
