...
Supported formats: JPEG, PNG, GIF, and WebP. The format is detected from the file content. See the [Files API guide](</guides/files_api>) for details.
