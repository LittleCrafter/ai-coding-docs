...
Use _!`command`_ to inject [bash command](./tui.md#bash-commands) output into your prompt.
...
If this is a [subagent](./agents.md#subagents) the command will trigger a subagent invocation by default.
...
Use the `subtask` boolean to force the command to trigger a [subagent](./agents.md#subagents) invocation.
