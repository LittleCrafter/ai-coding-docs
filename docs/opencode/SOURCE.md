...
- **Canonical source:** https://github.com/anomalyco/opencode (`packages/web/src/content/docs/`)
- **Official docs site:** https://opencode.ai/docs/
- **License:** MIT License — see [`./LICENSE`](./LICENSE) (copied verbatim from
