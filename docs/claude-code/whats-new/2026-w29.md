...
> Pull live data into published artifacts through MCP connectors, and use Claude Code with a screen reader in the new screen reader mode.
  ...
  <span>Releases <a href="../changelog.md#2-1-207">v2.1.207 → v2.1.212</a></span>
  ...
  [Video demo](https://mintcdn.com/claude-code/ItzF3QVI6L0QypjJ/images/whats-new/artifacts-mcp.mp4?fit=max&auto=format&n=ItzF3QVI6L0QypjJ&q=85&s=ff8b81ed52b26c773899dc28cec959e6)
  ...
  <a href="../accessibility.md#turn-on-screen-reader-mode">Turn on screen reader mode</a>
  ...
  Other wins
    ...
    <div>`--forward-subagent-text` and <code>CLAUDE\_CODE\_FORWARD\_SUBAGENT\_TEXT</code> include subagent text and thinking blocks in <a href="../headless.md">stream-json output</a></div>
