...
<div className="digest-feature">
  ...
  <Frame>
    <img className="w-full" src="../media/images/whats-new/routines.png" alt="Creating a routine on Claude Code on the web with schedule, GitHub event, and API triggers" width="1440" height="810" data-path="images/whats-new/routines.png" />
  </Frame>
...
<div className="digest-feature">
  ...
  <Frame>
    <img className="w-full" src="../media/images/whats-new/usage.png" alt="The /usage command showing a breakdown of what's contributing to limits usage" width="1204" height="1182" data-path="images/whats-new/usage.png" />
  </Frame>
