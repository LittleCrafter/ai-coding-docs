...
<div className="digest-feature">
  ...
  <Frame>
    <img className="w-full" src="../media/images/whats-new/ios-simulator.jpg" alt="Claude Code Desktop with the iOS Simulator pane showing an iPhone app next to the conversation" width="2048" height="1152" data-path="images/whats-new/ios-simulator.jpg" />
  </Frame>
