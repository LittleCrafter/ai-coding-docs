...
<div className="digest-feature">
  ...
  <Frame>
    <img className="w-full" src="../media/images/whats-new/fast-mode-opus-47.png" alt="The Claude Code model picker showing Opus 4.7 Fast 1M as the default with the Fast toggle on" width="3840" height="2160" data-path="images/whats-new/fast-mode-opus-47.png" />
  </Frame>
