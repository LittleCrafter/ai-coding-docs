...
<Frame>
  <img src="media/images/statusline-multiline.png" alt="A multi-line status line showing model name, directory, git branch on the first line, and a context usage progress bar with cost and duration on the second line" width="776" height="212" data-path="images/statusline-multiline.png" />
</Frame>
...
<Frame>
  <img src="media/images/statusline-quickstart.png" alt="A status line showing model name, directory, and context percentage" width="726" height="164" data-path="images/statusline-quickstart.png" />
</Frame>
...
<Frame>
  <img src="media/images/statusline-context-window-usage.png" alt="A status line showing model name and a progress bar with percentage" width="448" height="152" data-path="images/statusline-context-window-usage.png" />
</Frame>
...
<Frame>
  <img src="media/images/statusline-git-context.png" alt="A status line showing model, directory, git branch, and colored indicators for staged and modified files" width="742" height="178" data-path="images/statusline-git-context.png" />
</Frame>
...
<Frame>
  <img src="media/images/statusline-cost-tracking.png" alt="A status line showing model name, session cost, and duration" width="588" height="180" data-path="images/statusline-cost-tracking.png" />
</Frame>
...
<Frame>
  <img src="media/images/statusline-links.png" alt="A status line showing a clickable link to a GitHub repository" width="726" height="198" data-path="images/statusline-links.png" />
</Frame>
