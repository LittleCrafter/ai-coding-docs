...
1. **Register an OAuth client in your IdP**
...
1. **Deploy the opt-in in the managed settings file**
...
2. **Mirror the snippet to any source that outranks the file**
...
3. **Check which source is selected**
