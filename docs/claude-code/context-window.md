...
| Environment info | Auto-loaded | 280 | Invisible in your terminal | Working directory, platform, shell, OS version, and whether this is a git repo. Git branch, status, and recent commits load as a separate block. |
