...
1. **Enable the skills for your claude.ai account**
...
2. **Run Claude Code in non-interactive mode with syncing turned on**
...
3. **Confirm the skills load in a local session**
