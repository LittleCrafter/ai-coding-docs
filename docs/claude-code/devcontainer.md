...
<img src="media/images/devcontainer-architecture.svg" alt="Diagram showing an editor on the host connecting to a Docker dev container. Claude Code, the terminal, and build tools run inside the container. The host repository is bind-mounted into the container as the workspace." width="640" height="300" />

<img src="media/images/devcontainer-architecture-dark.svg" alt="Diagram showing an editor on the host connecting to a Docker dev container. Claude Code, the terminal, and build tools run inside the container. The host repository is bind-mounted into the container as the workspace." width="640" height="300" />
...
1. **Create or update devcontainer.json**
