...
*   **Query Balance**: Run the **[AI Credits Command](./commands/credits.md)** to open the dedicated credits panel. This panel displays your detailed credit usage statistics.
...
*   **[AI Credits Command](./commands/credits.md)**: View and manage your credits interactively in the TUI.
*   **[Model Quotas Command](./commands/usage.md)**: Monitor your model-specific API quotas.