...
| Page | Local | Source |
| --- | --- | --- |
| Reviewing artifacts | [cli/artifacts.md](./cli/artifacts.md) | [source](<https://antigravity.google/docs/cli/artifacts>) |
| Best practices for Antigravity CLI | [cli/best-practices.md](./cli/best-practices.md) | [source](<https://antigravity.google/docs/cli/best-practices>) |
| Managing conversations | [cli/conversations.md](./cli/conversations.md) | [source](<https://antigravity.google/docs/cli/conversations>) |
...
| Using AGY CLI | [cli/using.md](./cli/using.md) | [source](<https://antigravity.google/docs/cli/using>) |
| Vim editor mode | [cli/vim-editor-mode.md](./cli/vim-editor-mode.md) | [source](<https://antigravity.google/docs/cli/vim-editor-mode>) |

## cli/commands

| Page | Local | Source |
| --- | --- | --- |
| Agents Command (/agents) | [cli/commands/agents.md](./cli/commands/agents.md) | [source](<https://antigravity.google/docs/cli/commands/agents>) |
| Code Search Command (/codesearch) | [cli/commands/codesearch.md](./cli/commands/codesearch.md) | [source](<https://antigravity.google/docs/cli/commands/codesearch>) |
| AI Credits Command (/credits) | [cli/commands/credits.md](./cli/commands/credits.md) | [source](<https://antigravity.google/docs/cli/commands/credits>) |
| Diff Command (/diff) | [cli/commands/diff.md](./cli/commands/diff.md) | [source](<https://antigravity.google/docs/cli/commands/diff>) |
| Permissions Command (/permissions) | [cli/commands/permissions.md](./cli/commands/permissions.md) | [source](<https://antigravity.google/docs/cli/commands/permissions>) |
| Resume Command (/resume) | [cli/commands/resume.md](./cli/commands/resume.md) | [source](<https://antigravity.google/docs/cli/commands/resume>) |
| Status Line Command (/statusline) | [cli/commands/statusline.md](./cli/commands/statusline.md) | [source](<https://antigravity.google/docs/cli/commands/statusline>) |
| Window Title Command (/title) | [cli/commands/title.md](./cli/commands/title.md) | [source](<https://antigravity.google/docs/cli/commands/title>) |
| Model Quotas (/usage) | [cli/commands/usage.md](./cli/commands/usage.md) | [source](<https://antigravity.google/docs/cli/commands/usage>) |
| Voice Dictation (/voice) | [cli/commands/voice.md](./cli/commands/voice.md) | [source](<https://antigravity.google/docs/cli/commands/voice>) |
