...
| :----------------------------------------------------------- | :-----: | :--------------------------------------------------------------- | :----------------------------------------------------- | :-------: |
| [**Google Antigravity CLI**](./docs/google-antigravity-cli/) | 1.1.27  | antigravity.google/docs/cli/                                     | scraping (sitemap → `<url>.md`)                        |    ✅     |
| [**Claude Code**](./docs/claude-code/)                       | 2.1.263 | code.claude.com/docs/en/                                         | scraping (sitemap → `<url>.md`)                        |     —     |
