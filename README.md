...
| [**Codex CLI**](./docs/codex-cli/)                           | 0.157.0 | learn.chatgpt.com (`/docs/`) + github.com/openai/codex (`docs/`) | scraping (learn.chatgpt.com pages listed in the codex/llms.txt index + the openai/codex git tree) |     —     |
