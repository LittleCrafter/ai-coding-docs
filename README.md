...
| [**Claude Code**](./docs/claude-code/)                       | 2.1.277 | code.claude.com/docs/en/                                         | scraping (sitemap → `<url>.md`)                                                                   |     —     |
...
| [**Kimi Code**](./docs/kimi-code/)                           |  2.0.1  | github.com/MoonshotAI/kimi-code (`docs/en/`)                     | scraping (GitHub tree → VitePress `.md` → Markdown)                                               |     —     |
