...
| [**Claude Code**](./docs/claude-code/)                       | 2.1.283 | code.claude.com/docs/en/                                         | scraping (sitemap → `<url>.md`)                                                                   |     —     |
| [**Codex CLI**](./docs/codex-cli/)                           | 0.157.1 | learn.chatgpt.com (`/docs/`) + github.com/openai/codex (`docs/`) | scraping (learn.chatgpt.com pages listed in the codex/llms.txt index + the openai/codex git tree) |     —     |
