...
| [**Claude Code**](./docs/claude-code/)                       | 2.1.282 | code.claude.com/docs/en/                                         | scraping (sitemap → `<url>.md`)                                                                   |     —     |
| [**Codex CLI**](./docs/codex-cli/)                           | 0.156.1 | learn.chatgpt.com (`/docs/`) + github.com/openai/codex (`docs/`) | scraping (learn.chatgpt.com pages listed in the codex/llms.txt index + the openai/codex git tree) |     —     |
| [**DeepSeek API**](./docs/deepseek-api/)                     |    —    | api-docs.deepseek.com                                            | scraping (HTML → Markdown via `html2text`)                                                        |     —     |
| [**Kimi Code**](./docs/kimi-code/)                           |  2.1.1  | github.com/MoonshotAI/kimi-code (`docs/en/`)                     | scraping (GitHub tree → VitePress `.md` → Markdown)                                               |     —     |
