...
| [**Claude Code**](./docs/claude-code/)                       | 2.1.267 | code.claude.com/docs/en/                                         | scraping (sitemap → `<url>.md`)                        |     —     |
| [**Codex CLI**](./docs/codex-cli/)                           | 0.154.0 | github.com/openai/codex (`docs/`)                                | scraping (GitHub tree → `raw.githubusercontent.com`)   |     —     |
